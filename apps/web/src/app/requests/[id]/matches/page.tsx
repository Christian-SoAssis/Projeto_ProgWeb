...
import { ChevronLeft, MapPin, Star, DollarSign, Inbox } from "lucide-react"
...
export default function MatchesPage() {
    ...
    const { request, matches, loading } = useMatches(requestId)
        ...
        <main className="min-h-screen bg-background pb-20 px-6 max-w-lg mx-auto">
            <div className="pt-6 pb-2 flex items-center justify-between">
                ...
                <Button
                    ...
                    size="sm"
                    className="h-8 px-3 rounded-xl text-xs font-bold text-primary"
                    onClick={() => router.push(`/requests/${requestId}/bids`)}
                >
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="flex justify-between items-start gap-2">
                                        <h4 className="font-bold text-base truncate">
                                            {prof.bio?.slice(0, 40) || "Profissional"}
                                        </h4>
